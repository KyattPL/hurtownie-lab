...
ALTER TABLE Pynka.DIM_STATION
ADD CONSTRAINT dim_station_fk_install FOREIGN KEY (Installation_Date) REFERENCES Pynka.DIM_TIME(PK_TIME);

ALTER TABLE Pynka.DIM_WEATHER
ADD CONSTRAINT dim_weather_fk_date FOREIGN KEY (Measure_Date) REFERENCES Pynka.DIM_TIME(PK_TIME);
