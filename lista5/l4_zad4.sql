...
ALTER TABLE Pynka.FACT_SALES
ADD CONSTRAINT fact_sales_fk_orderdate FOREIGN KEY (OrderDate) REFERENCES Pynka.DIM_TIME(PK_TIME);

ALTER TABLE Pynka.FACT_SALES
ADD CONSTRAINT fact_sales_fk_shipdate FOREIGN KEY (ShipDate) REFERENCES Pynka.DIM_TIME(PK_TIME);